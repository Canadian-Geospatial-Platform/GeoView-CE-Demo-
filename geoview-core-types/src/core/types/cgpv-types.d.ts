...
export interface TypeWindow extends Window {
  ...
  plugins: {
    [pluginId: string]:
      | ((pluginId: string, props: TypeJsonValue) => TypeJsonValue)
      | AbstractPluginClass
      | undefined;
  };
}
...
export declare type TypeJsonValue =
  | null
  | string
  | number
  | boolean
...
export declare type TypeStampedIconCreationFunction = (
  Stamp: string,
) => L.DivIcon;
 ...
 */
export declare type TypeOfVector =
  | 'polyline'
  | 'polygon'
  | 'circle'
  | 'circle_marker'
 ...
 */
export declare type TypeVectorKeys =
  | 'POLYLINE'
  | 'POLYGON'
  | 'CIRCLE'
  | 'CIRCLE_MARKER'
...
export declare type TypeMapCorePackages =
  | 'overview-map'
  | 'basemap-switcher'
  | 'layers-panel'
  | 'details-panel'
 ...
 */
export interface TypeCustomTextFieldProps
  extends Omit<BaseTextFieldProps, 'prefix'> {
  id: string;
 ...
 */
export declare type TypeWebLayers =
  | 'esriDynamic'
  | 'esriFeature'
  | 'geojson'
  | 'geoCore'
  ...
  | 'ogcWfs'
  | 'ogcWms';
export declare type LayerTypesKey =
  | 'ESRI_DYNAMIC'
  | 'ESRI_FEATURE'
  | 'GEOJSON'
  | 'GEOCORE'
